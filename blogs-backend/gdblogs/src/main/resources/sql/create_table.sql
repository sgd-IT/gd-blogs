...
-- 为文章表添加类型字段
ALTER TABLE post ADD COLUMN type varchar(32) DEFAULT 'original' NOT NULL COMMENT '文章类型：original(原创)/share(分享)' AFTER categoryId;
...
INSERT INTO user (userAccount, userPassword, userName, userRole, userProfile) VALUES ('admin', '6ea864fd823636b777cb2f8e4287d499', 'Admin', 'admin', 'System Administrator'),
                                                                                     ('guest', '6ea864fd823636b777cb2f8e4287d499', 'Guest', 'guest', '游客账号');
