    ...
    <div className="relative flex min-h-[900px] w-full flex-col items-center justify-center overflow-hidden bg-transparent py-20">
      ...
      <div className="z-10 relative" style={{ perspective: 1000 }}>
        ...
        >
          ...
          {/* 添加一个反光层，增加质感 */}
          <div className="absolute inset-0 z-10 rounded-xl bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none" />
        </motion.div>
      </div>
    </div>
  );
